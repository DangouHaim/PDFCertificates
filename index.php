				...
				<form role="form" action="createPdf.php" method="POST">
					  ...
					  <div class="form-group">
					  	<div class="col-sm-6">
					    	...
					    	<input name="Country" required type="text" class="form-control" id="idCountry" placeholder="Страна" value="Russia">
						</div>
					  </div>
					...
					<br>
						...
						<div class="form-group">
						  	<div class="col-sm-4">
						  		<label for="idMounth">Месяц</label>
					...
					<br>
						...
						<div class="form-group">
					  	...
					  	<div class="form-group">
						  	<div class="col-sm-12">
						  		<label for="idName">Имя (можно несколько в столбик)</label>
					  			<textarea name="name" required class="form-control" rows="3" id="idName"></textarea>
					  		</div>
					  	</div>
					...
					<div class="form-group">
						<div class="col-sm-12">
							...
							<button type="submit" class="btn btn-primary btn-block">Сгенерировать</button>
							<p id="res"></p>
						</div>
					</div>
				</form>
